package com.example.demo.product.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleBadRequestAlertException(
        ...
        return create(
                ...
                HeaderUtil.createFailureAlert(
                        applicationName, false, ex.getEntityName(), ex.getErrorKey(), ex.getMessage()));
    }
    ...
    public ProblemBuilder prepare(
        ...
        if (activeProfiles.contains(ProductServiceConstants.SPRING_PROFILE_PRODUCTION)) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
                message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.example.demo");
    }
}
